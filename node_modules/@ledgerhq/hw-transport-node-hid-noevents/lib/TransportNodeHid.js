...
var isDisconnectedError = function (e) {
...
var TransportNodeHidNoEvents = /** @class */ (function (_super) {
    ...
    function TransportNodeHidNoEvents(device) {
        ...
        _this.writeHID = function (content) {
            ...
            try {
                ...
                if (isDisconnectedError(e)) {
                    ...
                    return Promise.reject(new errors_1.DisconnectedDevice(e.message));
                }
            ...
            return new Promise(function (resolve, reject) {
                return _this.device.read(function (e, res) {
                    ...
                    if (e) {
                        if (isDisconnectedError(e)) {
                            _this.setDisconnected();
                            return reject(new errors_1.DisconnectedDevice(e.message));
                        }
                        reject(e);
                    }
                    else {
        ...
        _this.deviceModel =
            info && info.product ? devices_2.identifyProductName(info.product) : null;
        return _this;
    }
    /**
    ...
    TransportNodeHidNoEvents.listen = function (observer) {
        getDevices().forEach(function (device) {
            var deviceModel = devices_2.identifyUSBProductId(device.productId);
            observer.next({
                type: "add",
