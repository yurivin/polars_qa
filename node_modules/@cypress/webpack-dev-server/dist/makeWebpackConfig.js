...
const debug = debug_1.debug('cypress:webpack-dev-server:makeWebpackConfig');
...
function makeWebpackConfig(userWebpackConfig, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const mergedConfig = webpack_merge_1.merge(userWebpackConfig, webpack_config_1.default(template), dynamicWebpackConfig);
