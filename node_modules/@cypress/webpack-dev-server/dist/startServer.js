...
const debug = debug_1.default('cypress:webpack-dev-server:start');
function start(_a, exitProcess = process.exit) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const webpackConfig = yield makeWebpackConfig_1.makeWebpackConfig(userWebpackConfig || {}, Object.assign({ files: options.specs, template,
            projectRoot,
        ...
        if (package_json_1.default.version.match(/3\./)) {
            webpackDevServerConfig = Object.assign(Object.assign({}, webpackDevServerConfig), { inline: false, publicPath: devServerPublicPathRoute, noInfo: false });
        }
        else if (package_json_1.default.version.match(/4\./)) {
            webpackDevServerConfig = Object.assign(Object.assign({}, userWebpackConfig === null || userWebpackConfig === void 0 ? void 0 : userWebpackConfig.devServer), { devMiddleware: {
                    publicPath: devServerPublicPathRoute,
                }, hot: false });
        }
        else {
            throw Error(`@cypress/webpack-dev-server only supports webpack-dev-server v3 and v4. Found: ${package_json_1.default.version}.`);
        }
