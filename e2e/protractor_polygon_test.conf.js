var Config = require('./config_polygon_test.data.json');
    ...
    capabilities: {
        ...
        'chromeOptions': {
            args: ['--disable-touch-touch-drag-drop', '--disable-infobars',
                ...
                '--load-extension=/Users/ihor/Documents/Polars_pro/nkbihfbeogaeaoehlefnkodbefgpgknn', '--app-id = mpjiecdeagakfpaembbldgmncdegnjin'],
            prefs: {
                'download': {
