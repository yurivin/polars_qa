...
describe('Leverage', function () {
    ...
    describe('user is able to add and remove liquidity', function () {
        ...
        it('should fill amount', async function () {
            await liquidityPage.inputAdd(1);
        });
    ...
    describe('user is able to make leverage on custom event', function () {
        ...
        it('should select both platforms', async function () {
            await adminPage.selectPolPlatform(platforms.pol);
        });
        ...
        it('should slide amount', async function () {
            await makePredictionPage.moveSlider()
            await browser.sleep(2000);
        });
    ...
    describe('user is able to make leverage on crypto event', function () {
